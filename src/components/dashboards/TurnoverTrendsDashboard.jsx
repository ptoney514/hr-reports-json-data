 ...
 * Historical turnover analysis from Q1 FY23 to Q2 FY26 (14 quarters)
      ...
      <div className="w-[85%] max-w-[1280px] mx-auto pt-5 pb-8">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-lg mt-2">
                  Historical Turnover Patterns • Q1 FY23 - Q2 FY26
                </p>
        ...
        <div className="bg-white rounded-2xl border p-8 mb-8" style={{ borderColor: colors.grid }}>
          <h2 className="text-2xl font-bold mb-6" style={{ color: colors.text }}>
            Overall Turnover Trends (Q1 FY23 - Q2 FY26)
          </h2>
          ...
          <div className="text-center mt-4 rounded-lg p-3" style={{ backgroundColor: '#B5D2F3' }}>
            ...
            <span className="text-sm" style={{ color: colors.text }}>
              Overall turnover includes all benefit-eligible terminations (voluntary, involuntary, retirement, end of assignment) from Q1 FY23 through Q2 FY26.
            </span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl border p-8 mb-8" style={{ borderColor: colors.grid }}>
          <h2 className="text-2xl font-bold mb-6" style={{ color: colors.text }}>
            Early Turnover Trends (&lt;1 Year Tenure, Q1 FY23 - Q2 FY26)
          </h2>
          <ResponsiveContainer width="100%" height={350}>
