  ...
  return (
    <div className="min-h-screen print:bg-white print:min-h-0">
      <div className="w-[90%] max-w-[1400px] mx-auto pt-5 pb-8 space-y-5 print:w-full print:max-w-none print:px-2 print:py-1 print:space-y-2">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4" role="region" aria-label="Key performance indicators">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-5 border-t-4 border-t-blue-500">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Total Headcount</h2>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-5 border-t-4 border-t-green-500">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide">{quarterConfig?.label} New Hires</h2>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-5 border-t-4 border-t-red-500">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide">{quarterConfig?.label} Separations</h2>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border p-5 border-t-4 border-t-amber-500">
            <div className="flex items-center gap-2 mb-2">
              ...
              <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide">Open Reqs</h2>
            </div>
        ...
        {/* ── WORKFORCE SNAPSHOT ── */}
        <div>
          <h2 className="text-base font-bold text-gray-500 uppercase tracking-wide mb-3">Workforce Snapshot</h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {/* Turnover by Tenure Donut */}
            <div className="bg-white rounded-lg shadow-sm border p-6" style={{ minHeight: 280 }}>
              <h3 className="text-lg font-bold text-gray-900 mb-1">Turnover by Tenure</h3>
            ...
            {/* Gender Breakdown */}
            <div className="bg-white rounded-lg shadow-sm border p-6" style={{ minHeight: 280 }}>
              <h3 className="text-lg font-bold text-gray-900 mb-1">Gender Breakdown</h3>
        ...
        <div>
          <h2 className="text-base font-bold text-gray-500 uppercase tracking-wide mb-3">Workforce Distribution</h2>
